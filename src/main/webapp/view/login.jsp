...
<div class="container" style="margin: 5%">
    ...
    <h2 style="color: #03cafc; text-align: center" > Login! </h2>

    <c:url var="loginsubmission" value="/loginsubmission"/>

    <form:form action="${loginsubmission}" method="post" modelAttribute="user">
        <div class="mb-3">
