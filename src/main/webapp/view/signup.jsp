...
<div class="container" style="margin: 5%">
    ...
    <h2 style="color: #03cafc; text-align: center" > Sign up! </h2>

    <c:url var="signupsubmission" value="/signupsubmission"/>

    <form:form action="${signupsubmission}" method="post" modelAttribute="user">
        ...
        <div class="mb-3">
            <form:label for="role" class="form-label" path="role">Role: </form:label>
